...
<div align="center">
  <h1>Prisma</h1>
  <a href="https://www.npmjs.com/package/qustar"><img src="https://img.shields.io/npm/v/qustar.svg?style=flat" /></a>
  <a href="https://github.com/tilyupo/qustar/blob/main/CONTRIBUTING.md"><img src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg" /></a>
  <a href="https://github.com/tilyupo/qustar/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-MIT%202-blue" /></a>
</div>
...
Qustar works with many SQL databases:

- SQLite
- MySQL (work in progress)
- PostgreSQL (work in progress)
- Oracle (work in progress)
- SQL Server (work in progress)
- MariaDB (work in progress)

While qustar supports many SQL dialects for databases from the list above, it can't connect and execute queries on its own. Qustar delegates it to _connectors_. There are many ready to use connectors that wrap existing NodeJS drivers:
